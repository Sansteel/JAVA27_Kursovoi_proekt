...
public class TextGraphicsConverterImpl implements TextGraphicsConverter {
    ...
    public String convert(String url) throws IOException, BadImageSizeException {
        ...
        if (ratio > maxRatio) throw new BadImageSizeException(ratio, maxRatio); //todo попробовал по своему реализовать
        ...
        System.out.println("TEST: newImg width/height/ratio: " + width + "/" +
                height + "/" + ratio);
        ...
        // параметром чёрно-белую палитру:
